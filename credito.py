...
1.  **Análise do Resultado:** De forma amigável, explique em 3-5 frases os principais motivos que levaram à decisão de '{resultado_texto}', baseando-se nos fatores mais recorrentes nas explicações. Use os resultados gerados no SHAP, LIME, ELI3 e Anchor e coloque R$ antes dos resultados de valores de valor dos seus imóveis, salário e carros. 
Fale sobre "pontos positivos", "pontos a melhorar", "seu perfil financeiro", etc.

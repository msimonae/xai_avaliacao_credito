...
1.  **Análise do Resultado:** De forma amigável e empática, explique todas as principais motivos que levaram à decisão. Mencione todos os fatores do SHAP e todas as regras do LIME e **liste em bullet points**. Para os resultados SHAP descrever apenas as variáveis importantes.Para todos os resultado do LIME, explique em linguagem natural como a condição do fator influenciaram o resultado '{resultado_texto}'. Formate valores monetários com R$ e use vírgulas e pontos decimais de forma correta (Exemplo: R$ 50.000,00).

2.  **Pontos a Melhorar (se o resultado for 'Recusado')**: Se o crédito foi recusado, Diga que seu crédito foi recusado e forneça 3 ou 5 dicas práticas e acionáveis sobre como o cliente pode melhorar seu perfil para aumentar as chances de aprovação no futuro mostrando que se ultrapassar o limite das variáveis da regra do LIME existe possibilidade de aprovação. Se foi aprovado, parabenize o cliente e apenas reforce os pontos positivos.
